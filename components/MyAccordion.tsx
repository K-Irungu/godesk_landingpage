...
import 'flowbite'; // This line imports Flowbite's JS

export default function MyAccordion() {
  useEffect(() => {
    // Flowbite's JavaScript automatically scans for data attributes
    // when imported.
  }, []);
  ...
  return (
    <div
      ...
      data-active-classes="bg-[#5ca206] text-white font-semibold text-xl"
      data-inactive-classes="text-gray-500"
    >
      <h2 id="accordion-flush-heading-1">
        <button
          type="button"
          className="flex items-center justify-between w-full py-5 px-10 font-semibold text-xl rtl:text-right text-gray-500 border-b border-gray-200 gap-3 hover:bg-[#5ca206] hover:text-white cursor-pointer"
